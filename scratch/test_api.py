...
async def main():
    async with httpx.AsyncClient() as client:
        ...
        r1 = await client.post('https://boostertea-os-backend.onrender.com/api/register', json=req1, timeout=30.0)
        ...
        r2 = await client.post('https://boostertea-os-backend.onrender.com/api/calculate', json=req2, timeout=30.0)
